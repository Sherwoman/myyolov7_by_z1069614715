...
from models.Models.Attention.AxialAttention import SelfAttention, AxialAttention, AxialImageTransformer
...
#################################
##### othermodule add by me #####
class v8Conv(nn.Module):
...
class v8Bottleneck(nn.Module):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = v8Conv(c1, c_, k[0], 1)
        self.cv2 = v8Conv(c_, c2, k[1], 1, g=g)
        self.add = shortcut and c1 == c2
...
class C2f(nn.Module):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.cv1 = v8Conv(c1, 2 * self.c, 1, 1, g=math.gcd(c1, 2 * self.c))
        self.cv2 = v8Conv((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList(v8Bottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
